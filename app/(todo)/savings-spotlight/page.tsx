...
const searchProducts = /* GraphQL */ `query SearchProducts(
  ...
  export const metadata: Metadata = {
    title: `Savings Spotlight - ${PAGE_TITLE}`,
    description: '',
  };


interface SavingspotLightProductsProps {
  limit?: number
}

export default async function SavingspotLightProducts(props: SavingspotLightProductsProps)  {
  ...
  return (
    <div className={`container-fluid ${!props?.limit && 'my-5'}`}>
      {!props?.limit &&
        <h3 className="mb-4">Saving Spotlight</h3>
      }
    <div className="row">
        {
                        ...
                        <div className="card card-product text-center">
                            ...
                            />
                             ...
                             <div className="d-flex justify-content-center">
                                ...
                                <p className="text-truncate" style={{fontSize: '14px'}}>Type: {item?.unitType}</p>
                                </div>
                            </div>
                        </div>
                        </a>
